...
TEST_ENTITY_DATA_FILE = f"{TEST_DATA_DIR}/entity_data.json"
TEST_RESPONSES_FILE = f"{TEST_DATA_DIR}/responses.json"
...
class VoicelineResource:
    ...
    def __init__(
        self,
        resource_file: str = TEST_RESPONSES_FILE,
        entity_data_file: str = TEST_ENTITY_DATA_FILE,
    ):
